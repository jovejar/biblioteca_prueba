...
BEGIN; SELECT nombre, apellido, (100* (fecha_dev_real - fecha_dev_esp)) AS multa_atraso, id_prestamo FROM prestamos FULL OUTER JOIN socios ON prestamos.rut_socio=socios.rut;
COMMIT;
